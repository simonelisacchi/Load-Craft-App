  ...
  if (!withVo2.length) {
    return (
      <p className="muted" style={{ fontSize: '0.85rem' }}>
        Nessuna stima VO2max ancora. Serve avere FC riposo e FC massima nel
        profilo <em>prima</em> di caricare una corsa, e che la corsa contenga
        un tratto a ritmo/FC sufficientemente stabile o sostenuto.
      </p>
    )
  }
