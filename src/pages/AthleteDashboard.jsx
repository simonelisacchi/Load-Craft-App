...
import GoogleHealthImport from '../components/GoogleHealthImport'
    ...
    <div>
          ...
          {selectedActivityId ? (
            ...
            <>
              ...
              <div className="card">
                ...
                <p className="muted" style={{ fontSize: '0.8rem', marginTop: -6 }}>Tocca un'attività per vedere mappa, FC e passo nel dettaglio.</p>
      ...
      {tab === 'Check-in' && (
        <>
          ...
          <GoogleHealthImport athleteId={profile.id} onImported={load} />
          <div className="card">
